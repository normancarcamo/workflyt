...
add constraint order_department_pkey
primary key (order_id, department_id);

-- foreign key: order_id

alter table order_department
add constraint order_department_order_id_fkey
foreign key (order_id)
...
add constraint order_employee_pkey
primary key (order_id, employee_id);

-- foreign key: order_id

alter table order_employee
add constraint order_employee_order_id_fkey
foreign key (order_id)
references orders(id)
on update cascade
on delete set null;
