...
export const get_warehouses = schema.request.keys({
...
export const create_warehouses = schema.request.keys({
  headers: schema.headers,
...
export const get_warehouse = schema.request.keys({
  headers: schema.headers,
  params: schema.params.keys({ warehouse: schema.id }),
});

export const update_warehouse = schema.request.keys({
  headers: schema.headers,
  params: schema.params.keys({ warehouse: schema.id }),
  body: schema.body.keys({
...
export const delete_warehouse = schema.request.keys({
  headers: schema.headers,
  params: schema.params.keys({ warehouse: schema.id }),
...
export const get_item = schema.request.keys({
  headers: schema.headers,
  params: schema.params.keys({ warehouse: schema.id, item: schema.id })
});
...
export default {
  // warehouse:
  get_warehouses: validate(get_warehouses),
  create_warehouses: validate(create_warehouses),
  get_warehouse: validate(get_warehouse),
  update_warehouse: validate(update_warehouse),
  delete_warehouse: validate(delete_warehouse),
  // warehouse_item:
