...
import { CategoryService } from '../../../../src/core/categories/categories-service';
import { I } from '../../../../src/core/categories/categories-types';
...
describe('Category Service', () => {
  ...
  beforeEach(async () => { service = CategoryService(repository); });
  ...
  describe('getMaterial', () => {
    it('should throw error when action fail', () => {
      ...
      // Act:
      const res = service.getMaterial(category_id, material_id, options);
    ...
    it('should return association when is found', async () => {
      ...
      // Act:
      const res = await service.getMaterial(category_id, material_id, options);
