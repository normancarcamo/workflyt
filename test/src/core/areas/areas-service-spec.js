...
const Service = require('src/core/areas/areas-service');
...
describe('Area Service', () => {
  ...
  describe('addSubareas', () => {
    it('should throw error when action fail', () => {
      ...
      // Act:
      const res = service.addSubareas(options);
    ...
    it('should return a list of associations after adding them', async () => {
      ...
      // Act:
      const res = await service.addSubareas(options);
  ...
  describe('getSubarea', () => {
    it('should throw error when action fail', () => {
      ...
      // Act:
      const res = service.getSubarea({ area_id, subarea_id, options }, true);
    ...
    it('should return association when is found', async () => {
      ...
      // Act:
      const res = await service.getSubarea({ area_id, subarea_id, options }, true);
  ...
  describe('addWorkers', () => {
    it('should throw error when action fail', () => {
      ...
      // Arrange:
      const options = { area_id: DATA.area.id, workers: [ DATA.worker.id ] };
  ...
  describe('getWorker', () => {
    it('should throw error when action fail', () => {
      ...
      // Act:
      const res = service.getWorker({ area_id, worker_id, options }, true);
    ...
    it('should return association when is found', async () => {
      ...
      // Act:
      const res = await service.getWorker({ area_id, worker_id, options }, true);
  ...
  describe('getService', () => {
    it('should throw error when action fail', () => {
      ...
      // Act:
      const res = service.getService({ area_id, service_id, options }, true);
    ...
    it('should return association when is found', async () => {
      ...
      // Act:
      const res = await service.getService({ area_id, service_id, options }, true);
